...
beautiful.init("/usr/share/awesome/themes/takeontom/theme.lua")
...
tags = {
	names = { 1, 2, 3, 4, 5, 6, 7, 8, "float" },
	layout = { layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[12] }
}
